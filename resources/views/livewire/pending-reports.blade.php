        ...
        <div class="h-full flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                <div class="max-w-7xl mx-auto space-y-6">
                    {{-- Superior Remarks Banner (if any report was returned for revision) --}}
                    @php
                        $revisionReport = collect($reports)->firstWhere('status', 'For Revision');
                    @endphp
                    @if ($revisionReport && $revisionReport->superior_remarks)
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-orange-700 dark:text-orange-400 whitespace-pre-wrap mb-2">
                                        {{ $revisionReport->superior_remarks }}
                                    </p>
                                    @if ($revisionReport->returned_at)
                                        <p class="text-xs text-orange-600 dark:text-orange-500">
                                            Returned on
                                            {{ \Carbon\Carbon::parse($revisionReport->returned_at)->format('F j, Y g:i A') }}
                                        </p>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" wire:click="openEditModal({{ $report->id }})"
            ...
            <div class="p-6 border-t border-zinc-200 dark:border-zinc-700 flex justify-end">
                <flux:button variant="ghost" type="button" wire:click="closeViewModal">
                    Close
                </flux:button>
            </div>
        </div>
